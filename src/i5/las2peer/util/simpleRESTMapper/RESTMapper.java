package i5.las2peer.util.simpleRESTMapper;
import i5.las2peer.util.simpleRESTMapper.PathTree.PathNode;
import i5.las2peer.util.simpleRESTMapper.Annotations.ContentParam;
import i5.las2peer.util.simpleRESTMapper.Annotations.DELETE;
...
import i5.las2peer.util.simpleRESTMapper.Annotations.PUT;
import i5.las2peer.util.simpleRESTMapper.Annotations.Path;
import i5.las2peer.util.simpleRESTMapper.Annotations.PathParam;
